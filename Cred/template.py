# template.py - CRED Interview Preparation Portal HTML Renderer

def render_cred_page(title, active_page, content_html, prev_link=None, prev_title=None, next_link=None, next_title=None):
    nav_items = [
        ...
        ("03_Domain_Deep_Dive.html", "03: Credit Risk, Fraud & GNNs", "Domain"),
        ("04_Candidate_Resume_Grilling.html", "04: Resume Defense & Traps", "Defense"),
        ("05_System_Design_or_HIL.html", "05: Real-Time Underwriting ML Design", "System Design"),
        ("06_Managerial_and_HR.html", "06: Life at CRED & Culture Fit", "Behavioral"),
        ("07_Quick_Reference.html", "07: Caveman & Ponytail CheatSheet", "CheatSheet"),
...
<body>
  ...
  <div class="app-container">
    ...
    <main class="main-content">
      <div class="top-bar">
        ...
        <span class="badge-cred">CRED · 24 LPA · M.Tech</span>
      </div>
  ...
  <script>
    ...
    function applyTheme(theme) {{
      ...
      localStorage.setItem('cred_prep_theme', theme);
      if (theme === 'dark') {{
    ...
    const savedTheme = localStorage.getItem('cred_prep_theme') || 'dark';
