# template.py - Pace Stock Broking Services Interview Preparation Portal HTML Renderer

def render_pace_page(title, active_page, content_html, prev_link=None, prev_title=None, next_link=None, next_title=None):
    nav_items = [
        ...
        ("02_Technical_Rounds.html", "02: Low-Latency C++ & OS", "Core Systems"),
        ("03_Domain_Deep_Dive.html", "03: Market Microstructure & LOB", "Architecture"),
        ("04_Candidate_Resume_Grilling.html", "04: Resume Defense & Traps", "Defense"),
        ("05_System_Design_or_HIL.html", "05: Limit Order Book LLD", "System Design"),
        ("06_Managerial_and_HR.html", "06: Prop Trading & Culture", "Behavioral"),
        ("07_Quick_Reference.html", "07: Caveman Quant CheatSheet", "CheatSheet"),
...
/* Typography & Markdown Render Styles */
h1, h2, h3, h4, h5, h6 {{
  color: var(--text-primary);
  font-weight: 800;
  letter-spacing: -0.02em;
...
<body>
  ...
  <div class="app-container">
    ...
    <aside class="sidebar" id="sidebar">
      <div class="sidebar-brand">
        <a href="index.html" class="brand-left">
          ...
          <div class="brand-text">
            <h2>Pace Stock Broking</h2>
            <span>Quant & Low-Latency HFT</span>
          </div>
        </a>
        <button class="drawer-close-btn" id="drawer-close-btn" aria-label="Close Drawer">✕</button>
      </div>
      ...
      <div class="sidebar-footer">
        ...
        <a href="../index.html" class="hub-return-btn" style="justify-content: center;">
          ← All Companies Hub
        </a>
      </div>
    </aside>
      ...
      <header class="top-bar">
        <div class="top-bar-left">
          ...
          <div class="breadcrumb">
            ...
            <span>/</span>
            <span style="color: var(--text-primary); font-weight: 600;">{active_page}</span>
          </div>
        </div>
        <div class="top-bar-right">
          <a href="07_Quick_Reference.html" class="hub-return-btn">⚡ CheatSheet</a>
        </div>
      </header>
  ...
  <nav class="bottom-nav">
    ...
    <a href="07_Quick_Reference.html" class="bottom-nav-item">
      <span class="bottom-nav-icon">⚡</span>
  ...
  <script>
    ...
    function setTheme(mode) {{
      if (mode === 'dark') {{
        ...
        localStorage.setItem('pace_theme', 'dark');
      }} else {{
        document.documentElement.removeAttribute('data-theme');
        if (themeIcon) themeIcon.textContent = '🌙';
        if (themeText) themeText.textContent = 'Dark Mode';
        localStorage.setItem('pace_theme', 'light');
      }}
    }}

    const savedTheme = localStorage.getItem('pace_theme') || 'dark';
    setTheme(savedTheme);
