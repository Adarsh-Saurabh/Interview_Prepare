#!/usr/bin/env python3
"""
generate_swiggy_suite.py
Generates the complete, mobile-ready interview preparation portal for Swiggy Data Scientist
in both Markdown (.md) and mobile-optimized HTML (.html) format.
"""

import os
import markdown

SWIGGY_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__)))

def render_swiggy_page(title, active_page, content_html, prev_link=None, prev_title=None, next_link=None, next_title=None):
    nav_items = [
        ("index.html", "Overview & Hub", "Portal"),
        ("00_START_HERE.html", "00: Company & Role Deep Dive", "Strategy"),
        ("01_Online_Test.html", "01: Signature OA Coding Problems", "Algorithms"),
        ("02_Technical_Rounds.html", "02: Machine Coding & ML Pipeline", "Coding"),
        ("03_Domain_Deep_Dive.html", "03: Swiggy Bytes & 4-Stage ETA", "Domain"),
        ("04_Candidate_Resume_Grilling.html", "04: Resume Defense & Logistics Grilling", "Defense"),
        ("05_System_Design_or_HIL.html", "05: Real-Time ETA & Dispatch ML Design", "System Design"),
        ("06_Managerial_and_HR.html", "06: Life at Swiggy & Cultural Values", "Behavioral"),
        ("07_Quick_Reference.html", "07: CheatSheet & Formula Vault", "CheatSheet"),
...
<head>
  ...
  <title>{title} · Swiggy DS Prep</title>
...
[data-theme="dark"] {{
  ...
  --accent-primary: #fc8019;
  --accent-primary-hover: #ea580c;
  --accent-light: rgba(252, 128, 25, 0.14);
  
  --tag-bg: rgba(252, 128, 25, 0.16);
  --tag-border: #ea580c;
  --tag-text: #fed7aa;
...
#reading-progress {{
  ...
  left: 0;
  height: 3px;
  background: linear-gradient(90deg, #fc8019, #f97316, #10b981);
  width: 0%;
  z-index: 2000;
...
<body>
  ...
  <div class="app-container">
      ...
      <div class="sidebar-brand">
        <a href="index.html" class="brand-left">
          ...
          <div class="brand-text">
            <h2>Swiggy DS Portal</h2>
            <span>Adarsh Saurabh · NIT Rourkela</span>
          </div>
        </a>
    ...
    <main class="main-content">
      <div class="top-bar">
        ...
        <div class="badge-swiggy">
          <span>⚡ Swiggy Data Scientist (26 LPA)</span>
        </div>
      </div>
  ...
  <script>
    ...
    function applyTheme(theme) {{
      ...
      localStorage.setItem('swiggy_prep_theme', theme);
      if (theme === 'dark') {{
    ...
    const savedTheme = localStorage.getItem('swiggy_prep_theme') || 'dark';
...
print("Swiggy template renderer module loaded.")
